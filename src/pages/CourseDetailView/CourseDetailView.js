    ...
    return (
        <React.Fragment>
            <section class="text-gray-600 space-y-28 sm:pt-6">
                ...
                <div>
                    <div className='sm:px-16 text-3xl mb-5 font-bold text-red-400 py-3 flex flex-col justify-between items-start'>
                    ...
                    <div class="flex flex-wrap px-4 sm:px-16 bg-gray-100 py-3">
                        {
                            props.history.location.state.map((el, index) => {
                                return (
                                    <div class="xl:w-1/4 md:w-1/2 w-full sm:w-0 sm:p-4 sm:mb-0 mb-14">
                                        <div class="bg-white border-2 cursor-pointer hover:border-indigo-400 hover:shadow-2xl  rounded-lg shadow-xl">
                                            <img class="rounded w-full object-cover object-center mb-6" src={"img/course-card-banners/" + el.img} alt="content" />
