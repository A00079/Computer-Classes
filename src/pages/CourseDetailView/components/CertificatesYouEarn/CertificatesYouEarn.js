            ...
            <section class="pt-20 2xl:pt-40 pb-40 2xl:pb-80 overflow-hidden">
                <div class="container px-4 mx-auto">
                    <div class="max-w-xl mx-auto mb-16 lg:mb-12 text-center">
                        <span class="text-lg font-bold text-blue-500">Start Up India</span>
                        <h2 class="mt-6 mb-12 text-6xl font-bold font-heading">Certified By Govt. Of India</h2>
                    </div>
                                ...
                                <div class="absolute bottom-0 left-0 w-full px-12">
                                    <div class="flex pt-10 pb-16 w-full border-t border-gray-200">
                                        <a class="inline-flex mr-10 w-20 h-20 items-center justify-center bg-white rounded-lg" href="#">
                                            <svg class="-mb-2 -mr-2" width="38" height="38" viewbox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div>
                                            <p class="mb-1 text-lg font-bold text-blue-500">DCS</p>
                                            <h4 class="text-2xl font-bold text-gray-400">Computer Institute</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <img class="hidden lg:block absolute top-0 right-0 mt-52 -mr-40" src="zospace-assets/images/blue-eclipse.png" alt="" />
                        </div>
                        <div class="w-full lg:w-1/2 px-10">
                            <div class="max-w-lg">
                                <ul>
                                    <li class="flex pb-2 mb-2 border-b border-gray-50">
                                        <div class="mr-8">
                                        ...
                                        <div class="max-w-xs">
                                            ...
                                            <p class="text-md">It&rsquo;s over, maecenas tincidunt malesuada dolor sit amet malesuada.</p>
                                        </div>
                                    </li>
                                    <li class="flex pb-2 mb-2 border-b border-gray-50">
                                        <div class="mr-8">
                                        ...
                                        <div class="max-w-xs">
                                            ...
                                            <p class="text-md">The brown me quam, sagittis porttitor lorem vel, commodo fringilla nisl.</p>
                                        </div>
                                    </li>
                                    <li class="flex pb-5 border-b border-gray-50">
                                        <div class="mr-8">
                                        ...
                                        <div class="max-w-xs">
                                            ...
                                            <p class="text-md">The time, this accumsan augue, posuere posuere elit lorem.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
