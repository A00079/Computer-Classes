        ...
        <section class="text-gray-600 body-font">
            <div className="container lg:text-center">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-12 gap-12 mt-16 px-20">
                        {
                            props.careerOptionsData.map((el, index) => {
                                return (
                                    <div class="sm:col-span-4  p-4 rounded-md border-gray-200 col-span-12">
                                        <img class="lg:w-20  mx-auto  w-full mb-2 rounded-sm object-cover object-center" src={"/img/career-options/"+el.img} alt="blog"></img>
