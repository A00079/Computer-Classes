    ...
    return (
        <div>
            ...
            <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:px-20">
                    <div class="w-full bg-white border-2 border-gray-100 shadow-xl rounded-lg p-4 flex flex-col justify-center items-center">
                        <div class="mb-8">
