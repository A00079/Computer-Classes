...
import animationData from '../../../src/lotties/man-working-on-computer.json';
      ...
      <section className="space-y-24">
        <div class="w-full bg-cover object-contained bg-center h-screen" style={{ backgroundColor: "#000" }}>
          <div class="flex items-center justify-center h-full w-full bg-gray-900 bg-opacity-50">
            <section class="text-gray-600 body-font mt-28 md:mt-10 relative">
              <div class="mx-auto flex pr-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:max-w-lg bg-gray-600 rounded-sm py-16 lg:w-full md:w-1/2 w-full">
                ...
                <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                  <h1 style={{ fontFamily: 'Luckiest Guy' }} class="animate__animated animate__backInLeft bg-white px-2 rounded-sm title-font sm:text-md text-md font-bold text-gray-600 tracking-wider">Grow your Skill's</h1>
                  <h1 style={{ fontFamily: 'Luckiest Guy' }} class="title-font sm:text-6xl text-3xl  mb-4 font-bold text-gray-400 tracking-wider animate__animated animate__backInLeft">We Just Dont't <br /> Teach We<br /> Inspire</h1>
                  <p class="mb-2 md:mb-1 leading-relaxed text-sm sm:text-md text-white font-bold tracking-wider">Chillwave portland ugh, knausgaard fam polaroid iPhone. Man braid swag typewriter affogato, hella selvage wolf narwhal dreamcatcher.</p>
                  ...
                  <div class="z-60 mt-3 flex lg:flex-row md:flex-col">
                    <button class="bg-yellow-400 inline-flex py-3 px-5 rounded-sm items-center md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
                      <span class="flex items-start flex-col leading-none">
                        <span class="title-font font-bold text-gray-200">Resgister Now</span>
                      </span>
                    </button>
                  </div>
                </div>
            ...
            <div className="absolute bottom-10 right-10 flex flex-col justify-start items-center w-full">
