          ...
          <div class="flex items-center justify-center h-full w-full bg-gray-900 bg-opacity-50">
            <section class="text-gray-600 body-font mt-28 md:mt-10 relative">
              <div class="mx-auto flex sm:pr-5 sm:py-24 md:flex-row flex-col items-center">
                <div class="lg:max-w-lg sm:bg-gray-600 py-7 rounded-sm sm:py-16 lg:w-full md:w-1/2 w-full">
                ...
                <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                  ...
                  <h1 style={{ fontFamily: 'Luckiest Guy' }} class="title-font sm:text-6xl text-2xl  mb-4 font-bold text-gray-400 tracking-wider animate__animated animate__backInLeft">We Just Dont't <br /> Teach We<br /> Inspire</h1>
